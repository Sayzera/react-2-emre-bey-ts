 ...
 * 
 * React'te class component kullanılarak oluşturulan error boundary.
 * Bu component, alt bileşenlerde oluşan render hatalarını yakalar.
 * 
 * ÖNEMLİ: Error Boundary sadece şu hataları yakalar:
 * - Render sırasında oluşan hatalar
 * - Lifecycle metodlarında oluşan hatalar
 * - Constructor'larda oluşan hatalar
 * 
 * YAKALAMAZ:
 * - Event handler'lardaki hatalar
 * - Async kod hataları (setTimeout, Promise, vb.)
 * - Server-side rendering hataları
 * - Error boundary'in kendisindeki hatalar
 */
                ...
                <AlertDescription className="mt-2">
                  <div className="space-y-2">
                    ...
                    {this.state.error?.name && (
                      <p>
                        <strong>Tip:</strong> {this.state.error.name}
                      </p>
                    )}
                  </div>
                </AlertDescription>
